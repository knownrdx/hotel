...
class Hotel(Base):
    ...
    mssql_table_booking = Column(String(255), default="Bookings")
    mssql_table_guest = Column(String(255), default="Guests")
    mssql_col_booking_id = Column(String(100), default="BookingID")
    mssql_col_guest_name = Column(String(100), default="GuestName")
    mssql_col_guest_phone = Column(String(100), default="Phone")
    mssql_col_room_number = Column(String(100), default="RoomNumber")
    mssql_col_checkin = Column(String(100), default="CheckInDate")
    mssql_col_checkout = Column(String(100), default="CheckOutDate")
    mssql_col_status = Column(String(100), default="Status")
    mssql_col_status_confirmed = Column(String(100), default="Confirmed")
